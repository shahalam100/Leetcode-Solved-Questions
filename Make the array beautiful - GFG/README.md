...
<p><span style="font-size:18px"><strong>Note:</strong>An empty array is also a beautiful array. There can be many adjacent integers which are different as stated above. So remove adjacent integers as described above from <strong>left to right</strong>.</span></p>
